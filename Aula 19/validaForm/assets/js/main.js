class ValidaFormulario {
  ...
  camposSaoValidos() {
    ...
    // este for é so para apagar os elementos criados para o erro
    ...
    for(let campo of this.formulario.querySelectorAll('.validar')) {   
      //console.log(campo);
      //console somente para teste 

      //pegar qual label está com erro
  ...
  criaErro(campo, msg) {
    //criando um campo para escrever o erro
    const div = document.createElement('div');
    div.innerHTML = msg;
    div.classList.add('error-text');
    //colocando o erro logo apos o campo que o erro foi encontrado
